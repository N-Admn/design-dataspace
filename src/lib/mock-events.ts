...
export const MOCK_EVENTS: EventRecord[] = [
  ...
  },
  {
    id: 'evt-5',
    status: 'published',
    createdAt: '18/06/2026 09:00:00',
    updatedAt: '22/06/2026 12:30:00',
    form: {
      metadata: {
        registrationRequired: true,
  ...
  },
  {
    id: 'evt-6',
    status: 'pending',
    createdAt: '02/06/2026 09:00:00',
    updatedAt: '09/06/2026 17:45:00',
    form: {
      metadata: {
        registrationRequired: true,
  ...
  },
  {
    id: 'evt-8',
    status: 'published',
    createdAt: '28/04/2026 09:00:00',
    updatedAt: '05/05/2026 14:20:00',
    form: {
      metadata: {
        registrationRequired: true,
